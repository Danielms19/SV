...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-09-2018 a las 02:01:46
...
(1, 'Conservas', 'Todas las conservas', 1),
(2, 'Florida', 'Todas las conserva', 0),
(3, 'pan', '', 0),
(4, 'Jugos', 'Todos los jugos.', 1),
(5, 'Bebidas', 'Todas las bebidas', 1),
(6, 'Lacteos', 'Todos los lacteos', 1),
(7, 'Verduras', 'Todas las verduras', 1),
(8, 'Dulces', 'Todos los dulces', 1);
...
(1, 'Charlie', '925687935', 'Puente Piedra', 1, 1, '12345678', 1),
(2, 'Melvyn Rodriguez', '01020304', 'Ventanilla', 1, 1, '87654321', 1);
...
(1, '001', 'Florida', 'Todas las conservas', '2.50', 44, 1, 1),
(2, '002', 'Pan', 'Todas las panes', '2.50', 50, 4, 1),
(3, '003', 'Coca Cola 1/2 Litro', 'Botella de vidrio', '3.00', 47, 5, 1),
(4, '004', 'Leche Gloria', 'Enriquecida con minerales y vitaminas', '4.00', 47, 6, 1),
(5, '005', 'Inca Kola 1L', 'Todas las bebidas', '4.50', 50, 5, 1),
(6, '006', 'Cifrut 3L', 'Fruit Pucnh', '4.50', 50, 5, 1),
(7, '007', 'Tampico', 'Citrus Punch', '4.30', 50, 5, 1);
...
(1, 'Administrador', 'Tiene acceso a todo las partes del sistema.'),
(2, 'Vendedor', 'Solo puede generar ventas.');
...
(1, 'Persona Natural', 'Clientes normales.'),
(2, 'Empresa', 'Clientes Empresa');
...
(1, 'Daniel', 'Mendoza', '941085678', 'mendozac800@gmail.com', 'admin', '1234', 1, 1),
(5, 'Mevlyn', 'Rodriguez', '52590297', 'melvyn80@gmail.com', 'admin2', '1234', 1, 1),
(6, 'Charlie ', 'Cieza', '1234569', 'ciezap@gmail.com', 'admin3', '1234', 2, 1);
...
(1, '2018-09-18', '2.50', '0.00', '0.00', '2.50', 2, 1, 1, '000001', '1'),
(2, '2018-09-18', '0.00', '0.00', '0.00', '0.00', 1, 1, 1, '000001', '1'),
(3, '2018-09-18', '0.00', '0.00', '0.00', '0.00', 2, 1, 1, '000002', '1'),
(4, '2018-09-18', '12.50', '0.00', '0.00', '12.50', 2, 1, 1, '000003', '1'),
(6, '2018-09-18', '0.00', '0.00', '0.00', '0.00', 2, 1, 1, '000004', '1'),
(7, '2018-09-18', '0.00', '0.00', '0.00', '0.00', 1, 1, 1, '000002', '1'),
(8, '2018-09-24', '21.00', '0.00', '0.00', '21.00', 2, 2, 1, '000005', '1');
