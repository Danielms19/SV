...
<head>
    ...
    <title>Supermarket Ramirez</title>
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="<?php echo base_url();?>dashboard" class="logo">
                ...
                <span class="logo-lg"><b>RAMIREZ</b></span>
            </a>
                                ...
                                <li class="user-body">
                                    <div class="row">
                                        <div class="col-xs-12 text-center">
                                            <a href="<?php echo base_url(); ?>auth/logout"><i class="fa fa-arrow-left" aria-hidden="true"></i> Cerrar Sesión</a>
                                        </div>
                                    </div>
                                    <!-- /.row -->
                                </li>
